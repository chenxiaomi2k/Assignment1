...
namespace DataAccess
{
    public class MemberDataProvider
    {
        ...
        public void Delete(string commandText, CommandType commandType, params SqlParameter[] sqlParameters)
        {
            try
            {
        ...
        public void Insert(string commandText, CommandType commandType, params SqlParameter[] sqlParameters)
        {
            try
            {
                using var connection = new SqlConnection(ConnectionString);
        ...
        public void Update(string commandText, CommandType commandType, params SqlParameter[] sqlParameters)
        {
            try
            {
                using var connection = new SqlConnection(ConnectionString);
